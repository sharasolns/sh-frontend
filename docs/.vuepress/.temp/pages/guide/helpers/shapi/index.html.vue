...
<p>This is used to make api requests to the backend using <em><a href="https://axios-http.com/docs/intro" target="_blank" rel="noopener noreferrer">axios<ExternalLinkIcon/></a></em></p>
...
<li>
<p>Example: <code v-pre>users</code></p>
</li>
<li>
<p>Details:</p>
